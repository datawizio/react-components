...
import PickerTrigger from "rc-picker/lib/PickerTrigger";
import PickerPanel from "./RcPickerPanel";
import usePickerInput from "rc-picker/lib/hooks/usePickerInput";
import getDataOrAriaProps, {
  toArray,
  getValue,
  updateValues
} from "rc-picker/lib/utils/miscUtil";
import {
  getDefaultFormat,
  getInputSize,
  elementsContains
} from "rc-picker/lib/utils/uiUtil";
import type { ContextOperationRefProps } from "rc-picker/lib/PanelContext";
...
import useValueTexts from "rc-picker/lib/hooks/useValueTexts";
import useTextValueMapping from "rc-picker/lib/hooks/useTextValueMapping";
import type { GenerateConfig } from "rc-picker/lib/generate";
import type { PickerPanelProps } from "rc-picker/lib";
import RangeContext from "rc-picker/lib/RangeContext";
// import useRangeDisabled from "rc-picker/lib/hooks/useRangeDisabled";
import getExtraFooter from "rc-picker/lib/utils/getExtraFooter";
import getRanges from "rc-picker/lib/utils/getRanges";
import useRangeViewDates from "rc-picker/lib/hooks/useRangeViewDates";
import type { DateRender } from "rc-picker/lib/panels/DatePanel/DateBody";
import useHoverValue from "rc-picker/lib/hooks/useHoverValue";
import { getClosingViewDate } from "./utils/dateUtil";
import useRangeDisabled from "./RcHooks/useRangeDisabled";
...
export type RangePickerBaseProps<DateType> = {} & RangePickerSharedProps<
  DateType
> &
...
function InnerRangePicker<DateType>(props: RangePickerProps<DateType>) {
  ...
  const [rangeHoverValue, setRangeHoverValue] = useState<RangeValue<DateType>>(
    null
  );

  // ========================== Hover Range ==========================
  const [hoverRangedValue, setHoverRangedValue] = useState<
    RangeValue<DateType>
  >(null);
